...
Real-time isn't banned. It's a tool with a narrow, real use. Reach for a call when:
...
Say the true thing, plainly, and assume the other person can handle it. Skip the compliment sandwich; people can smell the filler, and it makes the real feedback harder to find.

<Callout type="note" title="Feedback, briefly">
  Be specific, be timely, and talk about the work, not the person. "This section
  buries the point" is useful. "You're not a clear writer" is not. Praise the
  same way you criticize: concretely, and out loud.
</Callout>
...
Discord is where we talk with the people who use and follow the work. It's not a support ticket queue and it's not a marketing channel. It's a room where the company happens to be legible.
