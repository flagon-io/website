...
The honest heuristic: if a test would only ever fail because someone deliberately changed the behavior it pins, and that behavior doesn't matter, skip it.
