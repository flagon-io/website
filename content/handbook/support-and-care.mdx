...
<Callout type="note" title="The tone we're after">
  ...
  stuck: direct, warm, no theatre, and never pretending the problem is smaller
  than it is.
</Callout>
