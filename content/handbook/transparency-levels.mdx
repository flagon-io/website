...
description: We're public by default, but a few specific things aren't, and here's the honest reason for each.
section: How we work
order: 8
---

Building in the open is easy to say and harder to mean. The honest version has edges. We're public by default, genuinely, not as a marketing pose, but "default" is not "always," and pretending otherwise would be its own kind of dishonesty. So here's the actual boundary: what stays private, and why each thing earns its spot on the list.
...
Here's the test we actually use, and it's the thing to remember if you forget everything else on this page: secrecy has to justify itself. Openness doesn't.
...
None of this is a legal document, and it isn't the fine print on "built in the open." It's the same commitment, told honestly enough to include its own exceptions. For how this plays out day to day, see [how we communicate](/handbook/communication) and [how we work](/handbook/how-we-work).
