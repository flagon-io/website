...
[Our values](/handbook/values) tell you what we care about. They don't always tell you what to do at 4pm when you're staring at a pull request and two reasonable options. That's the gap these principles fill. A value poster you read once and forget changes nothing; a short named rule you can say out loud in a review actually moves a decision. So we gave the hard-won lessons names. When someone says "let's ship the thin slice" or "reversible, so just decide," everyone knows the shorthand, and the shared vocabulary does real work. Here's the list.
...
**Default to open.** Put the work, the reasoning, and the misfires where people can see them. Closing something should have to justify itself; opening it shouldn't.
...
**Cut the theatre.** No status meetings to prove work happened, no decks to make a simple point, no ceremony for its own sake. If a thing exists to look like progress rather than to make it, kill it.

**Play the long game.** Choose the option you won't resent in three years. Don't borrow against future trust, future code health, or people's energy to make this week look good.
