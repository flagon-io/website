...
Open is our default, not our exception. That covers the obvious stuff - the code - and the less obvious stuff, like this handbook, the roadmap, and the reasoning behind decisions that didn't go the way anyone expected. The bar isn't "why should we open this?" It's "is there a real reason not to?" Usually there isn't.
...
<Callout type="brand" title="The default">
...
The mistakes part is the one that matters. Anyone will show you the wins. Showing the false starts - the feature we killed, the call we got wrong, the thing we shipped and walked back - is what makes the rest believable. A track record with the losses edited out isn't a track record. It's marketing.
...
More on the mechanics in [how we build](/handbook/how-we-build), and on the why in our [values](/handbook/values). If something here reads as hollow, tell us - [hey@flagon.io](mailto:hey@flagon.io) - and we'll fix the page or fix the practice.
