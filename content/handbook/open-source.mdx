...
The mistakes part is the one that matters. Anyone will show you the wins. What makes the rest believable is showing the false starts: the feature we killed, the call we got wrong, the thing we shipped and walked back. A track record with the losses edited out isn't a track record. It's marketing.
