...
Good documentation is a feature, and we treat it like one. The docs are where a lot of people meet what we make: they arrive stuck on something specific, and the docs either get them unstuck or send them somewhere else. Stripe is our north star here, not because their prose is fancy but because their docs respect the reader's time and clearly took real work. That's the bar. This page is our stance on how we write docs and how we'll keep writing them.
...
<Callout type="note" title="The stuck-reader test">
