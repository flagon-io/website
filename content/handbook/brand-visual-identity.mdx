...
Two families do all the work. **Hanken Grotesk** sets headlines: tight tracking, a touch heavier, the display voice. **Geist Sans** carries body and UI. **Geist Mono** handles labels, code, and data. Uppercase captions get wide tracking; headings get tight.
