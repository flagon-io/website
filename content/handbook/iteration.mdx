...
Small changes also ship, which is the part that matters. A big change sits in a branch collecting conflicts and losing relevance while the world moves on. Ten small changes that each landed this week have already taught you ten things about whether you're right. The feedback loop is the whole game, and small changes are how you run it fast.
